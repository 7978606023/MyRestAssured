...
public class ExcelHelper {
    ...
    public static Object[][] getExcelData(String fileName, String sheetName) {
        ...
        try {
            wb = new XSSFWorkbook("C:\\Users\\kulka\\IdeaProjects\\RestAssuredProject\\src\\main\\resources\\TestData\\RestData.xlsx");
            //wb = new XSSFWorkbook(Constants.RESOURCES_PATH + "/data/"+ fileName);
